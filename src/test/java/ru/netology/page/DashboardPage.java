...
public class DashboardPage {
    ...
    public static ru.netology.page.TransactionPage pushFirstCardButton() {
        firstCardButton.click();
        return new ru.netology.page.TransactionPage();
    }

    public static ru.netology.page.TransactionPage pushSecondCardButton() {
